...
/***/ function(module, exports, __webpack_require__) {
	...
	query.simpleQuery({
		id: 'container',
		url: '/card/search',
		column: [{ id: 'cardId', type: 'text', name: '银行卡ID' }, { id: 'name', type: 'text', name: '名称' }, { id: 'bank', type: 'text', name: '银行' }, { id: 'remark', type: 'text', name: '备注' }, { id: 'createTime', type: 'text', name: '创建时间' }, { id: 'modifyTime', type: 'text', name: '修改时间' }],
