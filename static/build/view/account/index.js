...
/***/ function(module, exports, __webpack_require__) {
	...
	function go() {
		query.simpleQuery({
			id: 'container',
			url: '/account/search',
			column: [{ id: 'accountId', type: 'text', name: '账务ID' }, { id: 'name', type: 'text', name: '名称' }, { id: 'money', type: 'text', name: '金额' }, { id: 'type', type: 'enum', name: '类型', map: types }, { id: 'categoryId', type: 'enum', name: '分类', map: categorys }, { id: 'cardId', type: 'enum', name: '银行卡', map: cards }, { id: 'remark', type: 'text', name: '备注' }, { id: 'createTime', type: 'text', name: '创建时间' }, { id: 'modifyTime', type: 'text', name: '修改时间' }],
