...
/***/ function(module, exports, __webpack_require__) {
	...
	function go() {
		...
		total.money = 0;
		for (var i in statistic) total.money = total.money + parseInt(statistic[i].money);
		statistic.push(total);
		table.staticSimpleTable({
			id: 'container',
			data: statistic,
			column: [{ id: 'categoryName', type: 'text', name: '分类' }, { id: 'money', type: 'text', name: '金额' }, { id: 'precent', type: 'text', name: '占比' }],
			operate: []
		});
	}
	getData(function () {
