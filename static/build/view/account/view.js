...
/***/ function(module, exports, __webpack_require__) {
	...
	function go() {
		input.verticalInput({
			id: 'container',
			field: [{ id: 'name', type: 'text', name: '名称' }, { id: 'money', type: 'text', name: '金额' }, { id: 'type', type: 'enum', name: '类型', map: types }, { id: 'categoryId', type: 'enum', name: '分类', map: categorys }, { id: 'cardId', type: 'enum', name: '银行卡', map: cards }, { id: 'remark', type: 'text', name: '备注' }],
			value: account,
